...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="😔 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 😔", url="https://t.me/ParveenXfreeddos")
    button1 = types.InlineKeyboardButton(text="💔 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 💔",
        url="https://t.me/ParveenXfreeddos")
    markup.add(button3)
    markup.add(button1)
    return markup
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Please contact the owner for assistance: @Parveen_solanki.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/ParveenXfreeddos")
            markup.add(button1)
            markup.add(button2)
        else:
            ...
            button = types.InlineKeyboardButton(
                text="😈 𝐉𝐎𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 😈", url="https://t.me/ParveenXfreeddos")
            markup.add(button)
...
def owner_command(message):
    response = (
        ...
        "📩 **Telegram:** https://t.me/ParveenXfreeddos\n\n"
